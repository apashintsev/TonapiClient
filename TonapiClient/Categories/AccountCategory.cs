...
public class AccountCategory : CategoryBase
{
  ...
  /// </summary>
  public async Task<JettonBalance> GetJettonBalanceAsync(string accountId, string jettonId, CancellationToken ct = default)
  {
    return await GetAsync<JettonBalance>($"/v2/accounts/{accountId}/jettons/{jettonId}", ct);
  }
